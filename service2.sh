...
keywords=("arch_timer" "arm-pmu" "arch_mem_timer" "kgsl-3d0*" "msm_drm")
...
echo "El archivo msm_irqbalance.conf se ha modificado con éxito."


#!/bin/bash

# Palabras clave a buscar en /proc/interrupts
keywords=("kgsl-3d0*" "msm_drm")
...
echo "Los parametros se han modificado exitosamente."
